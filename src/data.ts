...
export const inputMeta:Record<keyof Inputs,InputMeta> = {
  ...
  rentGrowth:{label:'Rast nájomného',unit:'% p.a.',description:'Ročná indexácia príjmov z prenájmu Prahy a Berouna. Nájom budovy je z variantov vypnutý.',source:'Pracovný predpoklad',percent:true},
  ...
  buildingShare:{label:'Váš podiel na budove',unit:'% vlastníctva',description:'Ekonomický vlastnícky podiel používateľa; 50 % znamená polovicu hodnoty budovy a súvisiaceho financovania. Príjem z budovy je z variantov vypnutý.',source:'Údaj používateľa',percent:true},
  ...
  buildingRentEur:{label:'Nájom budovy',unit:'dočasne vypnuté',description:'Položka zostáva evidovaná, ale jej hodnota sa nepoužíva v príjme, cash flow, FIRE ani iných výpočtoch variantov.',source:'Potrebné doplniť'},
  buildingCostRate:{label:'Prevádzková rezerva budovy',unit:'% z nájmu',description:'Dočasne sa nepoužíva, pretože nájom budovy aj všetky náklady odvodené z jeho výšky sú z variantov úplne vylúčené.',source:'Potrebné doplniť',percent:true},
